...
function Clock() {
    ...
    const stringDate = date.toLocaleDateString('en-GB',{month:'2-digit', day:'2-digit', year: '2-digit'}) || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
